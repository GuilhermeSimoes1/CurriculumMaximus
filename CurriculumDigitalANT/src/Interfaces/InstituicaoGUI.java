...
public class InstituicaoGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jListCurriculum = new javax.swing.JButton();
        ...
        jListCurriculum.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/eye.png"))); // NOI18N
        jListCurriculum.setText("Visualizar Curriculum");
        jListCurriculum.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jListCurriculumActionPerformed(evt);
            }
        });
    ...
    private void jListCurriculumActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jListCurriculumActionPerformed
            ...
            try {
                ...
                List<String> lista = myremoteObject.getUserTransactionsInstitution(utilizador, instituicao);
                ...
                SwingUtilities.invokeLater(() -> {
                    ...
                    jList2.setModel(listModel); // Define o modelo no JList
                });
            } catch (RemoteException ex) {
                Logger.getLogger(UtilizadorGUI.class.getName()).log(Level.SEVERE, null, ex);
            }
        }).start();
    }//GEN-LAST:event_jListCurriculumActionPerformed
    ...
    private javax.swing.JButton jListCurriculum;
